...
// use palette::{IntoColor, FromColor}; // TODO: Re-enable color conversion
use rand::RngCore;
...
impl<'a> Shape<'a> {
    ...
    pub fn fill_color(mut self, color: tiny_skia::Color) -> Self {
        let mut paint = Paint {
            anti_alias: true,
            ..Default::default()
        };
    ...
    pub fn stroke_color(mut self, color: tiny_skia::Color) -> Self {
        let mut paint = Paint {
            anti_alias: true,
            ..Default::default()
        };
